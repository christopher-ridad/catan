...
### Other comments
Good work, team! No major issue found! Just make sure to remove temporary comments before the submission. For instance, in GameTest.java.

## Week 7 Code Review
I have read every line of production code currently in the main branch.

The code seems to be just placeholders, so there is not much I can comment on.  

Look forward to reviewing more of your code in the next review!
